 ...
 *  primed with the meeting (id + title) as context. `live` tunes the priming
 *  prompt: true = recording in progress (read transcript), false = finished
 *  meeting (prefer the saved summary). Returns a session id. */
